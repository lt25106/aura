...
const jonnycanvas = document.getElementById("JN")
...
{name: "ZX Mewer", amount: 0, baseCost: 69690, auraGain: 500, scale: 1.035},
{name: "CD Mewer", amount: 0, baseCost: 900000, auraGain: 6969, scale: 1.03},
{name: "Sigma CD", amount: 0, baseCost: 1069690, auraGain: 10000, scale: 1.025},
{name: "Sigma ZX", amount: 0, baseCost: 2000000, auraGain: 16969, scale: 1.02},
{name: "XH Mewer", amount: 0, baseCost: 100000000, auraGain: 69690, scale: 1.03},
{name: "Mutated XH", amount: 0, baseCost: 5000000000, auraGain: 3000000, scale: 1.025},
{name: "Geometry Dash", amount: 0, baseCost: 999999999, auraGain: 10000000, scale: 1.025}
]
...
{name: "x1.5 click", cost: 500000, effect: () => auraPerClick *= 1.5, bought: false},
{name: "x4 click", cost: 10000000, effect: () => auraPerClick *= 4, bought: false},
{name: "Sigma skibidi x2", cost: 10000000, effect: () => generators[5].auraGain *= 2, bought: false},
{name: "Sigma CD x2", cost: 500000000, effect: () => generators[8].auraGain *= 2, bought: false},
{name: "x10 click", cost: 2000000000, effect: () => auraPerClick *= 10, bought: false},
{name: "x10 click", cost: 9000000000, effect: () => auraPerClick *= 10, bought: false},
{name: "XH x2.5", cost: 90909090909, effect: () => generators[10].auraGain *= 2.5, bought: false} ,
{name: "x5 click", cost: 90909090969, effect: () => auraPerClick *= 5, bought: false},
{name: "Uno Reverse (x9999 click)", cost: 694206942069, effect: () => auraPerClick *= 9999, bought: false},
{name: "Mental Stability (x8 click)", cost: 83294783798, effect: () => auraPerClick *=8, bought: false},
{name: "^2 click", cost: 100, effect: () => auraPerClick **=2, bought: false}
]

const stocks = [
{name: "Mew Corp", price: 100, high: 100, low: 100, last: 100}, // = (s,i)
{name: "Cheap stocks", price: 2, high: 2, low: 2, last: 2},
{name: "AuraBank", price: 85, high: 85, low: 85, last: 85},
{name: "Toilet Inc.", price: 120, high: 120, low: 120, last: 120},
{name: "$15 penny", price: 15, high: 15, low: 15, last: 15},
...
const JNchart = charts(jonnycanvas, 'JN stocks', 2, 1, "#3da033")
